...
const ratgeberRohdaten = [
  ...
  {id: 3, slug: "Das perfekte Leben auf Social Media", erstellt: "", kategorie: RatgeberKategorie.MEDIEN},
  ...
  {id: 7, slug: "Vom Millionär zum Tellerwäscher in nur 7 Tagen", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 8, slug: "In 12 einfachen Schritten zum US-Präsidenten", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT},
  {id: 9, slug: "So wirst du zum modernen Künstler", erstellt: "", kategorie: RatgeberKategorie.KUNST_KULTUR},
  ...
  {id: 13, slug: "Intelligent werden mit KI", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 14, slug: "Muskelkater ohne Training", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 15, slug: "Kunstkritiker werden in nur 15 Minuten", erstellt: "", kategorie: RatgeberKategorie.KUNST_KULTUR},
  {id: 16, slug: "Erfolgreich werden ohne Leistung", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 17, slug: "Aluhüte im Alltag richtig verwenden", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 18, slug: "Warum beim Nachbarn das Gras immer viel grüner ist", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT},
  {id: 19, slug: "Termine vermeiden leicht gemacht", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 20, slug: "Zum Influencer in nur 2 Stunden", erstellt: "", kategorie: RatgeberKategorie.MEDIEN},
  {id: 21, slug: "Wie man jedes Buch als gesellschaftskritisch interpretiert", erstellt: "", kategorie: RatgeberKategorie.KUNST_KULTUR},
  {id: 22, slug: "Experte werden durch selbstbewusstes Auftreten", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 23, slug: "Wir haben das sicherste Passwort", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 24, slug: "Freunde finden in Dating-Portalen", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT}, 
  {id: 25, slug: "Warum ein Passwort für alles reicht", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 26, slug: "Glücklich werden durch niedrigere Erwartungen", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 27, slug: "Der perfekte Körper dank geschickter Beleuchtung", erstellt: "", kategorie: RatgeberKategorie.MEDIEN},
  {id: 28, slug: "Ratgeber schreiben mit KI", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK}, 
  {id: 29, slug: "Meetings überleben ohne Expertise", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF}, 
  {id: 30, slug: "Meisterwerke erkennen am Preisetikett", erstellt: "", kategorie: RatgeberKategorie.KUNST_KULTUR}, 
  {id: 31, slug: "Quellenangaben erfinden für Fortgeschrittene", erstellt: "", kategorie: RatgeberKategorie.MEDIEN}, 
  {id: 32, slug: "Wie man zuverlässig unzuverlässig wird", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 33, slug: "Gedanken lesen durch geschicktes Raten", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  ...
  {id: 36, slug: "So beweist man, dass die globale Erwärmung erfunden ist", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 37, slug: "Pünktlichkeit verbessern durch Zugausfälle", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 38, slug: "Diskussionen gewinnen durch konsequentes Dagegenreden", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT},
  {id: 39, slug: "Warum das Leben leichter ist, wenn man nichts versteht", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 40, slug: "Warum ich heute leider keine Zeit habe", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 41, slug: "Wie man aus Junk-Food Gourmet-Menüs bastelt", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 42, slug: "Sicherheit beim Bewerbungsgespräch trotz Mangel an Fachwissen", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 43, slug: "Plötzlich Privatdetektiv - Völlig unverdächtige Leute observieren", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT},
  {id: 44, slug: "Zugausfälle als Chance nutzen", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 45, slug: "Unsinn mit wissenschaftlichen Diagrammen belegen", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 46, slug: "Permanente Enttäuschung dank zu hoch gesteckter Ziele", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 47, slug: "Befördert werden ohne Qualifikation", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 48, slug: "Verwendung von KI durch Fehler vertuschen", erstellt: "", kategorie: RatgeberKategorie.WISSEN_TECHNIK},
  {id: 49, slug: "Die besten Ausreden für Verspätungen", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 50, slug: "Wie man aus einer kleinen Aufgabe ein Großprojekt macht", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 51, slug: "Komplimente machen, die garantiert falsch verstanden werden", erstellt: "", kategorie: RatgeberKategorie.LEBEN},
  {id: 52, slug: "E-Mails schreiben, die niemand beantworten möchte", erstellt: "", kategorie: RatgeberKategorie.ALLTAG_BERUF},
  {id: 53, slug: "Wie man beim ersten Eindruck einen bleibenden Schaden hinterlässt", erstellt: "", kategorie: RatgeberKategorie.GESELLSCHAFT},

...
Ein moderner Bahnbetrieb denkt weiter. Warum sollte man einen Zug mit zehn Minuten Verspätung ankommen lassen, wenn man ihn stattdessen einfach ausfallen lassen kann? Damit verschwindet nicht nur der Zug, sondern auch das Problem. Was nicht fährt, kann schließlich auch nicht zu spät kommen.

**Pünktlichkeit ist keine Frage der Ankunftszeit. Sie ist eine Frage der Definition.**

---

# Kapitel 1

## Vermeide jede Möglichkeit, zu spät zu kommen

Wenn du einen Termin um 10 Uhr hast und um 10:05 Uhr erscheinst, bist du zu spät. Das ist bedauerlich, aber eindeutig.

Wenn du dagegen überhaupt nicht erscheinst, entsteht eine wesentlich interessantere Situation. Du bist zwar nicht pünktlich angekommen, aber du bist auch nicht fünf Minuten zu spät.

Genau dieses Prinzip lässt sich hervorragend auf den Bahnverkehr übertragen. Ein Zug, der planmäßig fährt und zu spät kommt, erzeugt eine Verspätung. Ein Zug, der gar nicht fährt, erzeugt dagegen zunächst einmal nur eine Information auf der Anzeigetafel.

**Und Informationen haben keine Verspätung.**

---

# Kapitel 2

## Der wichtigste Schritt: Zug streichen

Nehmen wir an, dein Zug soll um 14:32 Uhr abfahren und um 16:17 Uhr ankommen. Du weißt bereits um 14:20 Uhr, dass der Zug erhebliche Schwierigkeiten hat und wahrscheinlich nicht pünktlich ankommen wird.
...
## Verstehe den Unterschied zwischen Verspätung und Ausfall

Eine Verspätung ist eine unangenehme Zahl. Sie lässt sich messen, vergleichen und in Tabellen darstellen. Zehn Minuten sind zehn Minuten, 30 Minuten sind 30 Minuten und ab einer gewissen Größenordnung beginnt jemand, von „erheblicher Verspätung“ zu sprechen.
...
## Vermeide den gefährlichen Begriff „zu spät“
...
**Was nicht mehr fährt, muss sich auch nicht für seine Verspätung rechtfertigen.**

---

# Kapitel 6

## Erzeuge neue Abfahrten

Ein ausgefallener Zug hinterlässt eine Lücke im Fahrplan. Das muss nicht zwangsläufig etwas Schlechtes sein.
...
## Nutze das Prinzip der maximalen Erwartungsfreiheit

Je weniger konkrete Erwartungen bestehen, desto leichter ist es, sie zu erfüllen.

Wenn du sagst:

> „Der Zug kommt um 16:17 Uhr.“

dann hast du dir selbst eine ziemlich präzise Aufgabe gestellt.

Wenn du dagegen sagst:

> „Der Zug kommt heute nicht.“

ist die Situation wesentlich einfacher.

Niemand erwartet mehr eine Ankunft um 16:17 Uhr. Niemand wartet auf genau diesen Zug. Und niemand kann später behaupten, er sei 23 Minuten zu spät gewesen.

**Keine Ankunft ist die sicherste Form der pünktlichen Nicht-Ankunft.**
...
## Verkaufe den Ausfall als Flexibilität
...
## Erkläre, dass Sicherheit vor Pünktlichkeit geht
...
## Entwickle den perfekten Pünktlichkeitsbegriff

Pünktlichkeit sollte nicht länger bedeuten, dass ein Zug exakt zur geplanten Zeit ankommt. Das wäre viel zu einfach.
...
## Denke wie ein Fahrgast

Natürlich solltest du trotz aller statistischen Vorteile nie vergessen, dass hinter jeder Zahl ein Mensch stehen kann.

Dieser Mensch möchte vielleicht zur Arbeit. Er möchte einen Arzttermin erreichen, seine Kinder abholen, einen Flug erwischen oder einfach nach Hause.
...
Du hast gelernt, dass Pünktlichkeit eine erstaunlich flexible Angelegenheit sein kann. Ein Zug, der fährt und zu spät kommt, ist ein Problem. Ein Zug, der gar nicht fährt, kann dagegen nicht zu spät kommen.
...
# BONUS: Der große Pünktlichkeits-Test

**1. Ist ein Zug pünktlich, wenn er zur geplanten Zeit ankommt?**

☐ Ja  
☐ Das wäre die traditionelle Definition

**2. Ist ein Zug verspätet, wenn er gar nicht fährt?**

☐ Nein  
☐ Jetzt wird es interessant

**3. Hast du schon einmal auf der Anzeigetafel „Zug fällt aus“ gelesen und kurz überlegt, ob das besser oder schlechter als 30 Minuten Verspätung ist?**

☐ Ja  
☐ Ich war plötzlich Statistiker

**4. Hast du schon einmal einen ausgefallenen Zug als „unerwartete Planänderung“ bezeichnet?**

☐ Ja  
☐ Klingt deutlich professioneller

**5. Hast du verstanden, dass ein Zug ohne Ankunft keine Ankunftsverspätung haben kann?**

☐ Ja  
☐ Mathematik kann manchmal tröstlich sein

**6. Hast du schon einmal einen späteren Zug genommen und dich gefragt, ob dieser jetzt eigentlich der Ersatz für den ausgefallenen Zug oder einfach nur der nächste Zug ist?**

☐ Ja  
☐ Hauptsache, er fährt

**7. Hast du schon einmal gedacht, dass eine Statistik ziemlich beeindruckend aussehen kann, wenn man bestimmte Ereignisse vorher aus ihr entfernt?**

☐ Ja  
☐ Ich würde das Optimierung nennen

**8. Hast du schon einmal einen Zugausfall erlebt, bei dem niemand so genau wusste, warum er ausgefallen ist?**

☐ Ja  
☐ Die Begründung war vermutlich unterwegs

**9. Würdest du einen Zug lieber 20 Minuten verspätet sehen oder vollständig ausfallen lassen?**

☐ Verspätet  
☐ Ich möchte einfach ankommen

**10. Hast du inzwischen verstanden, dass man Pünktlichkeit auch dadurch verbessern kann, dass man die Zahl der Züge reduziert, die überhaupt unpünktlich werden können?**
...
*Autor, Satiriker und überzeugt davon, dass ein Zug niemals zu spät kommen kann, wenn man rechtzeitig beschließt, dass er heute nicht fährt.*
